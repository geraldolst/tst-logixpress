...
@router.get("/stats")
async def get_shipment_statistics(current_user: User = Depends(require_role(["admin"]))):
    """
    **Shipment Statistics**
    ...
    **Requires:** Admin role
    ...
    return {"total_shipments": total, "by_status": status_counts}
...
async def health_check():
    ...
    **Health Check**
    ...
    """
    return {"status": "healthy", "service": "LOGIXPress API", "version": "1.0.0"}
